...
class Predictions:
    ...
    def evaluate(self, logger, mapping, decoder, lod, attrib_idx):
        ...
        with tf.Graph().as_default(), tf.compat.v1.Session() as sess:
            ds = tf.compat.v1.data.TFRecordDataset("principal_directions/generated_data.000")
        ...
        np.save("all_principal_directions/wspace_att_%d" % attrib_idx, results)
